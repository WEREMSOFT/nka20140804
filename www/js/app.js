(function() {
    'use strict';
    var app = angular.module('myApp', ['onsen.directives', 'ngSanitize', 'QuestionOnProduct', 'Cart', 'Register', 'CommingSoon', 'MainApp', 'ContactForm', 'List', 'Login', 'GridMenu', 'PendingCalifications', 'angular-carousel', 'ngDropdowns']);
    ...
    app.factory('userData', function($http) {
        ...
        returnValue.httpSuccess = function(data, status, headers, config) {
            ...
            if (data.result.logedIn === 1) {
                ...
                messageWindow('Nombre de usuario o contraseña inválidas.', alertDismissed, 'Opa!', 'Aceptar');
                returnValue.logout();
            }
        }
